...
$env.config = {
    ...
    explore: {
        status_bar_background: {fg: $color_palette.surface1, bg: $color_palette.subtext1},
        command_bar_text: {fg: $color_palette.subtext1},
        highlight: {fg: $color_palette.crust, bg: $color_palette.yellow},
        status: {
            error: {fg: $color_palette.text, bg: $color_palette.red},
            warn: {fg: $color_palette.text, bg: $color_palette.yellow},
            info: {fg: $color_palette.text, bg: $color_palette.sky},
        },
        table: {
            split_line: {fg: $color_palette.surface1},
            selected_cell: {bg: $color_palette.sapphire},
            selected_row: {},
            selected_column: {},
        },
    }
    ...
    menus: [
        ...
        # Note the lack of source parameter
        {
            ...
            style: {
                text: $color_palette.green
                selected_text: { fg: $color_palette.crust bg: $color_palette.green }
                description_text: $color_palette.yellow
            }
        }
        {
            name: history_menu
